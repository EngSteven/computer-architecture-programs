...
Datos Segment
    ...
    ayuda       db "Bienvenido y gracias por usar mi calendario:",10,13,
                ...
                db   "ingrese: compi nombrePrograma procedim fecha",10,13,
                db   " la fecha por commander line, con el formato: /a#anio/m#mes/",10,13,
                db   "   ",10,13,
...
Inicio:
    ...
    LimpiarPantalla                     ;se limpia el contenido de la pantalla
    ImprimirMensaje ayuda               ;se imprime el mensaje de ayuda al usuario
    LeerTecla al                        ;se espera a que se presione una tecla
    LimpiarPantalla                     ;se limpia de nuevo la pantalla
