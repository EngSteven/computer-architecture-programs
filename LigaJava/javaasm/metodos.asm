...
.code
;consejo -> poner en single los parametros recibidos
Java_ConversorAJuliano_calcularJuliano proc JNIEnv:DWORD, jobject:DWORD, Y:DWORD, M:DWORD, D:DWORD, S:DWORD 
